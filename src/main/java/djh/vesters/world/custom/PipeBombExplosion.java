...
public class PipeBombExplosion extends Explosion {
    ...
    public PipeBombExplosion(World world, @Nullable Entity entity, double x, double y, double z, float power) {
        super(world, entity, x, y, z, power, false, DestructionType.DESTROY_WITH_DECAY);
